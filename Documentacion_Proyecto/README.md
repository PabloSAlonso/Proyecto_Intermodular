...
* Creación de la base de datos y algunas tablas principales (usuarios, publicaciones e historias)

## 2º Semana enero
* Diseño móvil de página de inicio de sesión y página de registro
* Uso del framework de bootstrap en la web parala maquetación de las paginas realizadas
